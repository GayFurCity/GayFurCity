...
inline := |*
  ...
  'wiki'i ' 'i? 'page'i? ' #'i id              => { append_id_link("wiki", "wiki-page", "/wiki/", { a1, a2 }); };
  'wiki'i ' 'i? 'page 'i? 'changes'i? ' #'i id => { append_id_link("wiki changes", "wiki-page-changes-for", "/wiki/versions?search[wiki_page_id]=", { a1, a2 }); };
