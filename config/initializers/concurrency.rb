...
# Configure the thread pool used by promises (Concurrent::Promise) in the concurrent-ruby gem.
#
# We set the maximum number of threads to `GayFurCity.config.max_concurrency`, and we disable queueing
